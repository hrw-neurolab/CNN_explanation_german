<script>
  ...
  const errorCallback = () => {
    ...
    showLoading = false;
    errorInfo.show = true;
    errorInfo.error = usingURL ? "Wir konnten das Bild unter dieser URL nicht finden." :
  ...
  const loadCallback = () => {
    ...
    try {
      ...
      showLoading = false;
      errorInfo.show = true;
      errorInfo.error = "Keine Berechtigung, dieses Bild zu laden."
    }
  }
  ...
  <div class="modal"
    ...
    <div class="modal-card">
      <header class="modal-card-head">
        <p class="modal-card-title">Eingabebild hinzufügen</p>
