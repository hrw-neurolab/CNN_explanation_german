    ...
    <div class="content-container">
      <div class="left-part">
        ...
        <div class="input-row">
          <div class="field is-horizontal">
            <div class="field-label is-normal">
              <label class="label">Eingabegröße:</label>
            </div>
        ...
        <div class="input-row">
          <div class="field is-horizontal">
            <div class="field-label is-normal">
              <label class="label">Auffüllung (Padding):</label>
            </div>
        ...
        <div class="input-row">
          <div class="field is-horizontal">
            <div class="field-label is-normal">
              <label class="label">Schrittweite (Stride):</label>
            </div>
        ...
        <div class="right-part">
          ...
          <div class="annotation">
            ...
            <div class="annotation-text-hyper">
              <span style="font-weight:600">Fahre mit der Maus über</span> die Matrizen, um die Kernel-Position zu ändern.
            </div>
          </div>
